...
function CreateWndBG2(pElem,nWidth, h1, h2)
{
	...
	pRow1.style.height = h1;
	var pCell1 = pRow1.insertCell(-1);
	pCell1.style.backgroundImage = "url(" + gWebAPIPath + "/images/windows/004_01.png)";
	
	var pRow2 = pTbl.insertRow(-1);
	var pCell4 = pRow2.insertCell(-1);
	pCell4.style.backgroundImage = "url(" + gWebAPIPath + "/images/windows/004_02.png)";
	
	var pRow3 = pTbl.insertRow(-1);
	pRow3.height = h2;
	pRow3.style.height = h2;
	var pCell7 = pRow3.insertCell(-1);
	pCell7.style.backgroundImage = "url(" + gWebAPIPath + "/images/windows/004_03.png)";
...
function SWGPanel(pParentElem, nStyle, bFloat, bAllowClose)
{
	...
	if (bFloat)
	{
		...
		pD.style.backgroundImage = "url(" + gWebAPIPath + "/images/windows/004_04.png)";
		...
		if (bAllowClose)
		{
			...
			pImg.src= gWebAPIPath + "/images/icons/Close.png";
			pImg.border = "0";
	...
	pT1.style.backgroundImage = "url(" + gWebAPIPath + "/images/windows/004_05.png)";
	var pRow = pC.insertRow(-1);
	pT2 = pRow.insertCell(-1);
	pT2.style.backgroundImage = "url(" + gWebAPIPath + "/images/windows/004_06.png)";
	pT2.style.padding = "0px 9px 3px 9px";
	var pRow = pC.insertRow(-1);
	pRow.style.height = "8px";
	pT3 = pRow.insertCell(-1);
	pT3.style.backgroundImage = "url(" + gWebAPIPath + "/images/windows/004_07.png)";
